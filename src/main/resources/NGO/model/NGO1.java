...
@NoArgsConstructor
public class NGO1 implements NGO {
    @Id
    ...
    public NGO1(String restaurantName, long userID, String availability, String email, String phoneNumber, String address, int accountStatus)
    {
